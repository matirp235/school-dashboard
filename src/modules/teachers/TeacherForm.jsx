...
// FIX: Extracted outside to prevent focus loss on typing
...
export default function TeacherForm({ initial, onClose }) {
  ...
  const submit = async () => {
    ...
    try {
      // Assuming your teacherStore accepts plain JSON objects (unlike students which needed FormData for photos)
