...
// FIX 1: Move the helper component OUTSIDE the main component 
  ...
  <div>
    ...
    {opts ? (
      ...
      <input 
        ...
        value={value} 
        onChange={e => onChange(k, e.target.value)}
        // FIX 2: Better calendar interaction
...
export default function StudentForm({ initial, onClose }) {
  ...
  const submit = async () => {
    ...
    // FIX 3: FormData is correctly used here for Multi-part uploads
    ...
    <div className="space-y-4">
      <div className="bg-blue-50 p-3 rounded-lg border border-blue-100">
        <p className="text-[10px] text-blue-700 leading-tight">
          <strong>Privacy Note:</strong> Data collected as per DPDP Act 2023 — minimal personal information for educational purposes only.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <FormField label="Gender" k="gender" value={form.gender} onChange={handleUpdate} required 
        ...
        <FormField label="Relation" k="guardian_rel" value={form.guardian_rel} onChange={handleUpdate} required 
          opts={['Father','Mother','Grandfather','Grandmother','Uncle','Aunt','Guardian']} />
